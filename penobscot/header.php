...
?>
<?php /* 
	30Oct15 - zig, use the html_after_header option only on the home page.
	        - zig - add call to gtm plugin function.
	3Dec15  - zig - add tagline under logo.
	5Dec15  - zig - moved top_bar_nav to right lights.
*/ ?>
<!DOCTYPE html>
			...
			<div class="row"> 
				<div class="large-12 columns header-container">
					...
					<div id="logo" class="logo-left">
						...
						<div id="tag-line"><?php bloginfo( 'description' ); /* zig */ ?></div> 
					</div><!-- .logo -->
					<?php endif; ?>
...
<?php if($flatsome_opt['html_after_header'] && is_front_page() ){ // zig 
