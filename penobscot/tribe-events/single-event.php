...
<?php if (get_the_ID() == 13398) { /* zig */ ?>
	<div class="pls-covid-warning" style="border:2px solid red; padding: 10px; margin-bottom: 20px; font-size: 1.2em;"> <strong>EVENT COVID POLICY:</strong> All participants attending the February 24th Dinner & Discuss event at PBLS will be asked to show proof of vaccination (valid vaccination card, clear digital image or printout), and be asked to wear masks when not seated, eating and/or drinking. Symptomatic persons are asked to please stay home (regardless of vaccination status). Space is limited to half capacity (20 guests) during the event to allow for more social distancing between patrons. Thank you for helping us stay safe!</div>
<?php } ?>
	<!-- Notices -->
