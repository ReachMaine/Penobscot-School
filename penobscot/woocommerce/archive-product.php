 ...
 */
/* Mods
 * 	14Dec15 zig - remove  breadcrumbs from category arhive
 * 				- use main sidebar for product categories.
 *  18Dec15 zig - move after category footer to within the content.
 */
...
<div class="large-12 columns">
    ...
    /* $defaults = array(
        'delimiter'  => '<span>/</span>',
        'wrap_before'  => '<h3 class="breadcrumb" itemscope="breadcrumb">',
        'wrap_after' => '</h3>',
        'before'   => '',
        'after'   => '',
        'home'    => 'Home'
...
<!-- Left Shop sidebar -->
		<div class="large-3 hide-for-small left columns">
			<div id="shop-sidebar" class="sidebar-inner">
           		<?php /*zig if(is_active_sidebar('shop-sidebar')) { dynamic_sidebar('shop-sidebar'); } else{ echo $no_widgets_msg; } */ ?>
           		<?php if(is_active_sidebar('sidebar-main')) { dynamic_sidebar('sidebar-main'); } else{ echo $no_widgets_msg; } ?>
            </div>
        </div>
...
<?php 
// GET CUSTOM HEADER CONTENT FOR CATEGORY
/* zig moved to under content if(function_exists('get_term_meta')){
	$queried_object = get_queried_object();
