...
/* 
 * mods
 *    24Nov15 zig - if no product image dont show. 
 *    3Dec15 zig - dont show category at top of product in grid style 1
 */
...
<div class="inner-wrap zig-wrap">
	<?php if ( has_post_thumbnail()){ // zig ?>
