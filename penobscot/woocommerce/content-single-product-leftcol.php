<?php
 /* mods 
  *  24Nov15 zig - if there is no thumbnail, dont show image box.
  *             - use smaller container for image (col 3 instead of 7) adjust 
  *  4Dec15 zig - use standard sidebar for products.
  */
...
<div class="row">    
        ...
        <div class="row">
            <?php if ( has_post_thumbnail() ) { ?>
                <div class="large-3 columns product-gallery">        
                ...
                </div><!-- end large-3 - product-gallery -->
                <div class="product-info large-9 small-12 columns left" style="position:relative;">
            <?php } else { ?>
                <div class="product-info large-12 small-12 columns left" style="position:relative;">
            <?php } 
